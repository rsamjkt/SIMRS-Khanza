...
-- ----------------------------
-- Table structure for mlite_inacbg_klaim
-- ----------------------------
DROP TABLE IF EXISTS `mlite_inacbg_klaim`;
CREATE TABLE `mlite_inacbg_klaim` (
  `no_rawat` varchar(17) NOT NULL,
  `no_sep` varchar(40) DEFAULT NULL,
  `status_klaim` enum('Terkirim','Grouping1','Grouping2','Final','DieditUlang','Gagal') NOT NULL DEFAULT 'Terkirim',
  `pesan_terakhir` text DEFAULT NULL,
  `hasil_grouping` text DEFAULT NULL,
...
-- ----------------------------
-- Table structure for mlite_inacbg_log
-- ----------------------------
DROP TABLE IF EXISTS `mlite_inacbg_log`;
CREATE TABLE `mlite_inacbg_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `no_rawat` varchar(17) NOT NULL,
  `no_sep` varchar(40) DEFAULT NULL,
  `status_kirim` enum('Sukses','Gagal') NOT NULL,
  `pesan_response` text DEFAULT NULL,
  `username_pengirim` varchar(30) DEFAULT NULL,
  `timestamp_kirim` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `no_rawat` (`no_rawat`)
) ENGINE=InnoDB AUTO_INCREMENT=126 DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;

-- ----------------------------
-- Table structure for mlite_klaim_manual_log
-- ----------------------------
DROP TABLE IF EXISTS `mlite_klaim_manual_log`;
CREATE TABLE `mlite_klaim_manual_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `no_rawat` varchar(17) NOT NULL,
  `no_sep` varchar(40) DEFAULT NULL,
  `action_type` enum('new','update') NOT NULL,
  `result_message` text DEFAULT NULL,
  `username` varchar(50) DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`id`) USING BTREE,
  KEY `idx_no_rawat` (`no_rawat`) USING BTREE,
  KEY `idx_no_sep` (`no_sep`) USING BTREE,
  KEY `idx_created_at` (`created_at`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;

-- ----------------------------
-- Table structure for mlite_sertisign_documents
-- ----------------------------
DROP TABLE IF EXISTS `mlite_sertisign_documents`;
CREATE TABLE `mlite_sertisign_documents` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `status` enum('pending','downloaded','error') NOT NULL DEFAULT 'pending',
  `signer_email` varchar(100) DEFAULT NULL,
  `signer_name` varchar(100) DEFAULT NULL,
  `signer_id` varchar(100) DEFAULT NULL,
