 ...
 */
 ...
 import java.text.SimpleDateFormat; // <-- Import ditambahkan
  ...
  */
 public final class SuratPernyataanPembiayaanNaikKelas extends javax.swing.JDialog {
     ...
     private SimpleDateFormat sdf = new SimpleDateFormat("dd-MM-yyyy"); // Formatter untuk tanggal

     public SuratPernyataanPembiayaanNaikKelas(java.awt.Frame parent, boolean modal) {
         super(parent, modal);
         initComponents();
         ...
         tabMode=new DefaultTableModel(null,new Object[]{
             "No.Pernyataan","No.Rawat","No.R.M.","Nama Pasien","Umur","J.K.","Tgl.Lahir","Tanggal","Nama Pembuat Pernyataan",
             "No.KTP P.P.","Pendidikan P.P.","Alamat Pembuat Pernyataan","No.Telp P.P.","Ruang Dipilih","Kelas Ruang",
             "Pernyataan Terhadap","Hak Kelas","Nama & Alamat Keluarga Terdekat","Pembayaran/Pembiayaan","NIP","Nama Petugas"
         }){
         ...
         for (i = 0; i < 21; i++) {
             ...
             // Pengaturan lebar kolom tetap sama
             ...
             else if(i==10){ column.setPreferredWidth(81); }
             else if(i==11){ column.setPreferredWidth(150); }
             else if(i==12){ column.setPreferredWidth(90); }
             else if(i==13){ column.setPreferredWidth(130); }
             else if(i==14){ column.setPreferredWidth(70); }
             else if(i==15){ column.setPreferredWidth(115); }
             else if(i==16){ column.setPreferredWidth(60); }
             else if(i==17){ column.setPreferredWidth(200); }
             else if(i==18){ column.setPreferredWidth(130); }
             else if(i==19){ column.setPreferredWidth(80); }
             else if(i==20){ column.setPreferredWidth(150); }
         }
         tbObat.setDefaultRenderer(Object.class, new WarnaTable());

         // Pengaturan batas input tetap sama
         ...
         // Pengaturan HTMLEditorKit tetap sama
         ...
         styleSheet.addRule( /* CSS rules tetap sama */
     ...
     // initComponents() tidak perlu diubah, jadi saya hilangkan dari sini agar tidak terlalu panjang
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Pernyataan Pembiayaan Naik Kelas Rawat Inap ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "11-04-2024" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "11-04-2024" }));
        ...
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "11-04-2024" }));
        ...
        jLabel14.setText("Pembuat Pernyataan :");
        ...
        RuangDipilih.setBounds(92, 150, 170, 23);
        ...
        jLabel12.setText("Kelas yang dipilih:");
        jLabel12.setName("jLabel12"); // NOI18N
        FormInput.add(jLabel12);
        jLabel12.setBounds(290, 150, 100, 23);
        ...
        jLabel24.setText("Pernyataan Terhadap");
        ...
        FormPhoto.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1), " Bukti Pengambilan Pernyataan : ", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50)));
        ...
        internalFrame1.getAccessibleContext().setAccessibleName("::[ Data Pernyataan Pembiayaan Naik Kelas Rawat Inap ]::");
        internalFrame1.getAccessibleContext().setAccessibleDescription("");

        pack();
    }// </editor-fold>//GEN-END:initComponents

     // Event handlers (BtnSimpan, BtnHapus, BtnEdit, BtnPrint, dll.) tetap sama seperti sebelumnya
     // ... (kode event handler dari BtnSimpan sampai BtnPrint1) ...
     // Event handlers tetap sama seperti yang sudah disesuaikan sebelumnya
     private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
         if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
             Valid.textKosong(TNoRw,"Pasien");
         }else if(NamaPJ.getText().trim().equals("")){
             Valid.textKosong(NamaPJ,"Nama Pembuat Pernyataan"); // Label disesuaikan
         }else if(AlamatPj.getText().trim().equals("")){
             Valid.textKosong(AlamatPj,"Alamat Pembuat Pernyataan"); // Label disesuaikan
             ...
             Valid.textKosong(NoSurat,"No. Pernyataan"); // Label disesuaikan
         }else{
             if(Sequel.menyimpantf("surat_pernyataan_pembiayaan_naik_kelas","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","Data",15,new String[]{
                ...
                // Panggil tampil() untuk merefresh data tabel dengan format tanggal yang benar dari database
                tampil();
                // // Kolom object array disesuaikan dengan header tabMode yang baru (secara urutan)
                // tabMode.addRow(new Object[]{
                //     NoSurat.getText(),TNoRw.getText(),TNoRM.getText(),TPasien.getText(),Umur.getText(),JK.getText(),LahirPasien.getText(), // LahirPasien sudah String dd-MM-yyyy
     ...
     private void BtnSimpanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnSimpanKeyPressed
         if(evt.getKeyCode()==KeyEvent.VK_SPACE){
             ...
             Valid.pindah(evt,NamaKeluarga,BtnBatal);
         }
     ...
     private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
         if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
             ...
             Valid.textKosong(NamaPJ,"Nama Pembuat Pernyataan");
         }else if(AlamatPj.getText().trim().equals("")){
             Valid.textKosong(AlamatPj,"Alamat Pembuat Pernyataan");
         }else if(NoTelp.getText().trim().equals("")){
             Valid.textKosong(NoTelp,"Nomor Telp");
         }else if(NoKTP.getText().trim().equals("")){
             Valid.textKosong(NoKTP,"Nomor KTP");
             ...
             try{
                 ...
                 htmlContent.append(
                     "<tr class='isi'>"+
                         ...
                         "<td valign='middle' bgcolor='#FFFAF8' align='center'><b>Nama Pembuat Pernyataan</b></td>"+
                         ...
                         "<td valign='middle' bgcolor='#FFFAF8' align='center'><b>Alamat Pembuat Pernyataan</b></td>"+
                         ...
                         "<td valign='middle' bgcolor='#FFFAF8' align='center'><b>Pernyataan Terhadap</b></td>"+
                 ...
                 File f = new File("DataPernyataanPembiayaanNaikKelas.html");
                             ...
                             "<table width='2200px' border='0' align='center' cellpadding='3px' cellspacing='0' class='tbl_form'>"+
                                 "<tr class='isi2'>"+
                                     "<td valign='top' align='center'>"+
                                         ...
                                         "<font size='2' face='Tahoma'>DATA PERNYATAAN PEMBIAYAAN NAIK KELAS<br><br></font>"+
                                     "</td>"+
                                "</tr>"+
                             "</table>")
                 );
     ...
     private void TNoRwKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TNoRwKeyPressed
         if(evt.getKeyCode()==KeyEvent.VK_PAGE_DOWN){
             ...
             Valid.pindah(evt,BtnAll,Tanggal);
         }
     }//GEN-LAST:event_TNoRwKeyPressed
 
     private void TanggalKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TanggalKeyPressed
         Valid.pindah(evt, TNoRw, btnPetugas);
     ...
     private void ChkAccorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkAccorActionPerformed
         if(tbObat.getSelectedRow()!= -1){
             ...
             ChkAccor.setSelected(false);
             JOptionPane.showMessageDialog(null,"Silahkan pilih No. Pernyataan terlebih dahulu..!!!");
         }
     ...
     private void btnAmbilActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if(tabMode.getRowCount()==0){
            ...
            TCari.requestFocus(); // Fokuskan ke field pencarian jika data habis
        } else {
            // Memeriksa apakah ada baris yang dipilih di tabel tbObat
            if(tbObat.getSelectedRow() > -1){
                // Ambil data dari baris yang dipilih
                String noSurat = tbObat.getValueAt(tbObat.getSelectedRow(), 0).toString();
                String kolomKedua = tbObat.getValueAt(tbObat.getSelectedRow(), 1).toString(); // Ambil data dari kolom kedua juga
    
                // Hapus semua data dari tabel antripersetujuanrawatinap
                // PERHATIAN: Ini akan menghapus SEMUA baris di tabel ini, pastikan ini memang yang diinginkan.
                Sequel.queryu("delete from antripersetujuanrawatinap");
    
                // Masukkan data baru ke tabel antripersetujuanrawatinap
                // Menggunakan data dari kolom pertama (index 0) dan kedua (index 1) dari baris yang dipilih
                Sequel.queryu("insert into antripersetujuanrawatinap values('"+ noSurat +"','"+ kolomKedua +"')");
    
                // Hapus data dari tabel surat_persetujuan_rawat_inap_pembuat_pernyataan berdasarkan no_surat
                Sequel.queryu("delete from surat_pernyataan_pembiayaan_naik_kelas_bukti where no_surat='"+ noSurat +"'");
    
                // (Opsional) Anda mungkin ingin menambahkan pesan sukses di sini jika perlu
                // JOptionPane.showMessageDialog(rootPane,"Data antrian persetujuan berhasil diproses untuk No.Persetujuan: " + noSurat);
     ...
     private void BtnPrint1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint1ActionPerformed
         if(tbObat.getSelectedRow()>-1){
             if(lokasifile == null || lokasifile.equals("")){
                 JOptionPane.showMessageDialog(null,"Maaf, Silahkan ambil atau refresh bukti foto pernyataan terlebih dahulu..!!!!");
             }else{
                 ...
                 Valid.MyReportqry("rptSuratPernyataanPembiayaanNaikKelas.jasper","report","::[ Surat Pernyataan Pembiayaan Naik Kelas ]::",
                     ...
                     "WHERE spnk.no_surat='"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"'",param);
             }
         }else{
     ...
     */
     public static void main(String args[]) {
         java.awt.EventQueue.invokeLater(() -> {
             SuratPernyataanPembiayaanNaikKelas dialog = new SuratPernyataanPembiayaanNaikKelas(new javax.swing.JFrame(), true);
     ...
     // =========================================================================
     // Perbaikan pada tampil(), getData(), dan isRawat() untuk format tanggal
     // =========================================================================
     ...
     public void tampil() {
         ...
         try{
             ...
             if(TCari.getText().trim().equals("")){
                 sql="SELECT spnk.no_surat,reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,reg_periksa.umurdaftar,"+
                     "reg_periksa.sttsumur,pasien.jk,pasien.tgl_lahir,spnk.tanggal,spnk.nama_pj,"+
                     "spnk.no_ktppj,spnk.pendidikan_pj,spnk.alamatpj,"+
                     "spnk.no_telppj,spnk.ruang,spnk.kelas,"+
                     "spnk.hubungan,spnk.hak_kelas,spnk.nama_alamat_keluarga_terdekat,"+
                     "spnk.bayar_secara,spnk.nip,petugas.nama FROM surat_pernyataan_pembiayaan_naik_kelas spnk "+
                     "INNER JOIN reg_periksa ON spnk.no_rawat=reg_periksa.no_rawat "+
                     "INNER JOIN pasien ON reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                     "INNER JOIN petugas ON spnk.nip=petugas.nip WHERE "+
                     "spnk.tanggal BETWEEN ? AND ? ORDER BY spnk.tanggal";
             }else{
                 sql="SELECT spnk.no_surat,reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,reg_periksa.umurdaftar,"+
                     "reg_periksa.sttsumur,pasien.jk,pasien.tgl_lahir,spnk.tanggal,spnk.nama_pj,"+
                     "spnk.no_ktppj,spnk.pendidikan_pj,spnk.alamatpj,"+
                     ...
                     "INNER JOIN pasien ON reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                     "INNER JOIN petugas ON spnk.nip=petugas.nip WHERE "+
                     "spnk.tanggal BETWEEN ? AND ? AND "+
                     "(reg_periksa.no_rawat LIKE ? OR pasien.no_rkm_medis LIKE ? OR pasien.nm_pasien LIKE ? OR "+
                     "spnk.alamatpj LIKE ? OR spnk.nama_pj LIKE ? OR "+
                     "spnk.nip LIKE ? OR petugas.nama LIKE ?) "+
                     "ORDER BY spnk.tanggal";
             }
             ...
             try {
                 ...
                 rs=ps.executeQuery();
                 //SimpleDateFormat sdf = new SimpleDateFormat("dd-MM-yyyy"); // Pindahkan ke atas jika belum ada
                 while(rs.next()){
                     // --- PERBAIKAN: Format Tgl Lahir SEBELUM addRow ---
                     String tglLahirFormatted = "";
                     java.sql.Date tglLahirSql = rs.getDate("tgl_lahir");
                     if (tglLahirSql != null) {
                         try {
                             tglLahirFormatted = sdf.format(tglLahirSql);
                         } catch (Exception e) {
                             tglLahirFormatted = "Invalid Date";
                             System.out.println("Error formatting tgl_lahir in tampil(): " + e + " for date: " + tglLahirSql);
                         }
                     }
                     // --- AKHIR PERBAIKAN ---

                     tabMode.addRow(new Object[]{
                         rs.getString("no_surat"),             // 0
                         rs.getString("no_rawat"),             // 1
                         rs.getString("no_rkm_medis"),          // 2
                         rs.getString("nm_pasien"),            // 3
                         rs.getString("umurdaftar")+" "+rs.getString("sttsumur"), // 4
                         rs.getString("jk"),                   // 5
                         tglLahirFormatted,                    // 6 <-- Masukkan String yang sudah diformat
                         rs.getString("tanggal"),              // 7
                         rs.getString("nama_pj"),              // 8
                         rs.getString("no_ktppj"),             // 9
                         rs.getString("pendidikan_pj"),        // 10
                         rs.getString("alamatpj"),             // 11
                         rs.getString("no_telppj"),            // 12
                         rs.getString("ruang"),                // 13
                         rs.getString("kelas"),                // 14
                         rs.getString("hubungan"),             // 15
                         rs.getString("hak_kelas"),            // 16
                         rs.getString("nama_alamat_keluarga_terdekat"), // 17
                         rs.getString("bayar_secara"),         // 18
                         rs.getString("nip"),                  // 19
                         rs.getString("nama")                  // 20
                     });
                 }
             } catch (Exception e) {
                 System.out.println("Notif tampil() inner: "+e);
             } finally{
                 if(rs!=null){ rs.close(); }
                 if(ps!=null){ ps.close(); }
             }
     ...
     public void emptTeks() {
         ...
         NoKTP.setText("");
         AlamatPj.setText("");
         Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(spnk.no_surat,3),signed)),0) from surat_pernyataan_pembiayaan_naik_kelas spnk where spnk.tanggal='"+Valid.SetTgl(Tanggal.getSelectedItem()+"")+"' ",
                 "PNK"+Tanggal.getSelectedItem().toString().substring(6,10)+Tanggal.getSelectedItem().toString().substring(3,5)+Tanggal.getSelectedItem().toString().substring(0,2),3,NoSurat);
         TNoRw.setText("");
         TNoRM.setText("");
         TPasien.setText("");
         Umur.setText("");
     ...
     private void getData() {
          if(tbObat.getSelectedRow()!= -1){
             ...
             // --- PENYESUAIAN TANGGAL LAHIR ---
             // Kolom 6 sekarang berisi String dd-MM-yyyy atau string kosong/error
         ...
         try {
             ...
             try {
                 ...
                 if(rs.next()){
                     ...
                     // Format tanggal lahir di isRawat
                     try {
                         java.sql.Date tglLahirSql = rs.getDate("tgl_lahir");
                         if (tglLahirSql != null) {
                             LahirPasien.setText(sdf.format(tglLahirSql)); // Gunakan sdf yang sudah didefinisikan
                         } else {
                             LahirPasien.setText("");
                         }
                     } catch (Exception e) {
                         LahirPasien.setText("Err");
                         System.out.println("Error formatting tgl_lahir di isRawat: " + e);
                     }
                     // ---
                     ...
                     Umur.setText(rs.getString("umurdaftar")+" "+rs.getString("sttsumur"));
                      ...
                      LahirPasien.setText("");
                      Umur.setText("");
                      JOptionPane.showMessageDialog(null,"Data Pasien dengan No. Rawat "+TNoRw.getText()+" tidak ditemukan.");
                 }
             } catch (Exception e) {
     ...
     // Fungsi setNoRm, isForm, isCek, ganti, hapus, isPhoto, panggilPhoto tetap sama
     ...
     public void isCek(){
         ...
         BtnPrint1.setEnabled(akses.getsurat_persetujuan_rawat_inap());
     ...
     private void ganti() {
         if(Sequel.mengedittf("surat_pernyataan_pembiayaan_naik_kelas","no_surat=?","no_surat=?,no_rawat=?,tanggal=?,nama_pj=?,no_ktppj=?,pendidikan_pj=?,alamatpj=?,"+
            ...
            // Panggil tampil() untuk merefresh data tabel dengan format tanggal yang benar dari database
            tampil();
            // int row = tbObat.getSelectedRow(); // Tidak perlu update manual jika panggil tampil()
            // tbObat.setValueAt(NoSurat.getText(),row,0);
            // ... (sisa setValueAt) ...
             emptTeks();
         }
     }
     ...
     private void hapus() {
         if(Sequel.queryu2tf("delete from surat_pernyataan_pembiayaan_naik_kelas where no_surat=?",1,new String[]{
     ...
     private void panggilPhoto() {
        // Mempertahankan pengecekan awal: Form harus visible DAN ada baris terpilih
        if(FormPhoto.isVisible()==true && tbObat.getSelectedRow() > -1){
            lokasifile=""; // Inisialisasi variabel path file
            try {
                // Query ke tabel yang BENAR: surat_pernyataan_pembiayaan_naik_kelas_bukti
                // Asumsi kolom yang menyimpan path adalah 'photo' (sesuaikan jika nama kolomnya beda, misal 'path_bukti')
                ps=koneksi.prepareStatement(
                    "SELECT photo FROM surat_pernyataan_pembiayaan_naik_kelas_bukti WHERE no_surat=?"); // Ganti nama tabel
                try {
                    // Ambil no_surat dari baris tabel yang dipilih
                    ps.setString(1,tbObat.getValueAt(tbObat.getSelectedRow(),0).toString());
                    rs=ps.executeQuery();
                    if(rs.next()){ // Jika data ditemukan
                        // Ambil path file dari hasil query
                        String fotoBukti = rs.getString("photo"); // Ganti nama variabel jika perlu
   
                        // Cek jika path kosong, null, atau "-" (mempertahankan cek asli yang lebih aman)
                        if(fotoBukti == null || fotoBukti.equals("")|| fotoBukti.equals("-")){
                            lokasifile="";
                            LoadHTML2.setText("<html><body><center><br><br><font face='tahoma' size='2' color='#434343'>Kosong</font></center></body></html>");
                        }else{
                            // Jika ada path, simpan dan buat HTML img
                            lokasifile=fotoBukti;
                            // Bangun URL dengan path context yang BENAR dan ukuran gambar yang DIMINTA
                            LoadHTML2.setText("<html><body><center><img src='http://"+koneksiDB.HOSTHYBRIDWEB()+":"+koneksiDB.PORTWEB()+"/"+koneksiDB.HYBRIDWEB()+"/pernyataanpembiayaannaikkelas/"+lokasifile+"' alt='photo' width='500' height='500'/></center></body></html>"); // Ganti path context & ukuran
                        }
                    }else{ // Jika data tidak ditemukan untuk no_surat tsb
                        lokasifile="";
                        LoadHTML2.setText("<html><body><center><br><br><font face='tahoma' size='2' color='#434343'>Kosong</font></center></body></html>");
                    }
                } catch (Exception e) { // Tangani error saat eksekusi query atau proses hasil
                    lokasifile="";
                    // Pesan error yang lebih informatif dari kode asli
                    LoadHTML2.setText("<html><body><center><br><br><font face='tahoma' size='2' color='#434343'>Gagal Memuat</font></center></body></html>");
                    System.out.println("Notif panggilPhoto() inner: "+e);
                } finally{ // Selalu tutup resource ResultSet dan PreparedStatement
                    if(rs!=null){ rs.close(); }
                    if(ps!=null){ ps.close(); }
                }
            } catch (Exception e) { // Tangani error saat prepare statement
                System.out.println("Notif panggilPhoto() outer: "+e);
            }
        // Mempertahankan penanganan jika form visible tapi tidak ada baris dipilih
        } else if (FormPhoto.isVisible()==true && tbObat.getSelectedRow() == -1){
             lokasifile="";
             LoadHTML2.setText("<html><body><center><br><br><font face='tahoma' size='2' color='#434343'>Silahkan Pilih Data</font></center></body></html>");
        }
    }
