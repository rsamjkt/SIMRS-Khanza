 ...
 */
public final class SuratPernyataanPembiayaanTindakan extends javax.swing.JDialog {
    ...
    public SuratPernyataanPembiayaanTindakan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setUndecorated(true);
        setResizable(false);
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Penyataan Pembiayaan Tindakan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("surat_pernyataan_pembiayaan_tindakan","?,?,?,?,?,?,?,?,?,?,?,?","Data",12,new String[]{
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(TCari.getText().trim().equals("")){
                Valid.MyReportqry("rptDataFormulirPernyataanPembiayaanTindakan.jasper","report","::[ Data Formulir Pernyataan Pembiayaan Tindakan ]::",
                    "select surat_pernyataan_pembiayaan_tindakan.no_surat,reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,reg_periksa.umurdaftar,"+
                    "reg_periksa.sttsumur,pasien.jk,pasien.tgl_lahir,surat_pernyataan_pembiayaan_tindakan.tanggal,surat_pernyataan_pembiayaan_tindakan.nama_pj,"+
                    "surat_pernyataan_pembiayaan_tindakan.no_ktppj,surat_pernyataan_pembiayaan_tindakan.tempat_lahirpj,surat_pernyataan_pembiayaan_tindakan.lahirpj,"+
                    "surat_pernyataan_pembiayaan_tindakan.jkpj,surat_pernyataan_pembiayaan_tindakan.alamatpj,surat_pernyataan_pembiayaan_tindakan.hubungan,"+
                    "surat_pernyataan_pembiayaan_tindakan.no_telp,surat_pernyataan_pembiayaan_tindakan.nip,petugas.nama from surat_pernyataan_pembiayaan_tindakan "+
                    "inner join reg_periksa on surat_pernyataan_pembiayaan_tindakan.no_rawat=reg_periksa.no_rawat "+
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on surat_pernyataan_pembiayaan_tindakan.nip=petugas.nip where "+
                    "surat_pernyataan_pembiayaan_tindakan.tanggal between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+"' order by surat_pernyataan_pembiayaan_tindakan.tanggal",param);
            }else{
                Valid.MyReportqry("rptDataFormulirPernyataanPembiayaanTindakan.jasper","report","::[ Data Formulir Pernyataan Pembiayaan Tindakan ]::",
                    "select surat_pernyataan_pembiayaan_tindakan.no_surat,reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,reg_periksa.umurdaftar,"+
                    "reg_periksa.sttsumur,pasien.jk,pasien.tgl_lahir,surat_pernyataan_pembiayaan_tindakan.tanggal,surat_pernyataan_pembiayaan_tindakan.nama_pj,"+
                   ...
                   "surat_pernyataan_pembiayaan_tindakan.jkpj,surat_pernyataan_pembiayaan_tindakan.alamatpj,surat_pernyataan_pembiayaan_tindakan.hubungan,"+
                    ...
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on surat_pernyataan_pembiayaan_tindakan.nip=petugas.nip where "+
                    "surat_pernyataan_pembiayaan_tindakan.tanggal between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+"' and "+
                    ...
                    "surat_pernyataan_pembiayaan_tindakan.alamatpj like '%"+TCari.getText().trim()+"%' or surat_pernyataan_pembiayaan_tindakan.nama_pj like '%"+TCari.getText().trim()+"%' or "+
                    "surat_pernyataan_pembiayaan_tindakan.nip like '%"+TCari.getText().trim()+"%' or petugas.nama like '%"+TCari.getText().trim()+"%') "+
                    "order by surat_pernyataan_pembiayaan_tindakan.tanggal",param);
            }  
        }
    ...
    private void BtnPrint1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint1ActionPerformed
        if(tbObat.getSelectedRow()>-1){
            if(lokasifile.equals("")){
                JOptionPane.showMessageDialog(null,"Maaf, Silahkan ambil photo bukti pernyataan pembiayaan tindakan terlebih dahulu..!!!!");
            }else{
                Map<String, Object> param = new HashMap<>();
                param.put("namars",akses.getnamars());
                param.put("alamatrs",akses.getalamatrs());
                ...
                param.put("emailrs",akses.getemailrs());
                param.put("logo",Sequel.cariGambar("select setting.logo from setting"));
                param.put("photo","http://"+koneksiDB.HOSTHYBRIDWEB()+":"+koneksiDB.PORTWEB()+"/"+koneksiDB.HYBRIDWEB()+"/pernyataanpembiayaantindakan/"+lokasifile);
                ...
                Valid.MyReportqry("rptSuratPernyataanPembiayaanTindakan.jasper","report","::[ Surat Pernyataan Pembiayaan Tindakan ]::",
                    "select surat_pernyataan_pembiayaan_tindakan.no_surat,reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,reg_periksa.umurdaftar,pasien.pekerjaan,pasien.tmp_lahir,concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) as alamat,reg_periksa.sttsumur,pasien.jk,pasien.tgl_lahir,surat_pernyataan_pembiayaan_tindakan.tanggal,surat_pernyataan_pembiayaan_tindakan.nama_pj,"+
		    "surat_pernyataan_pembiayaan_tindakan.no_ktppj,surat_pernyataan_pembiayaan_tindakan.tempat_lahirpj,surat_pernyataan_pembiayaan_tindakan.lahirpj,surat_pernyataan_pembiayaan_tindakan.jkpj,surat_pernyataan_pembiayaan_tindakan.alamatpj,surat_pernyataan_pembiayaan_tindakan.hubungan,surat_pernyataan_pembiayaan_tindakan.no_telp,surat_pernyataan_pembiayaan_tindakan.nip,petugas.nama from surat_pernyataan_pembiayaan_tindakan inner join reg_periksa on surat_pernyataan_pembiayaan_tindakan.no_rawat=reg_periksa.no_rawat "+
		    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis inner join petugas on surat_pernyataan_pembiayaan_tindakan.nip=petugas.nip inner join kelurahan on pasien.kd_kel=kelurahan.kd_kel inner join kecamatan on pasien.kd_kec=kecamatan.kd_kec inner join kabupaten on pasien.kd_kab=kabupaten.kd_kab inner join propinsi on pasien.kd_prop=propinsi.kd_prop "+
                    "where surat_pernyataan_pembiayaan_tindakan.no_surat='"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"'",param);
            }
        }else{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SuratPernyataanPembiayaanTindakan dialog = new SuratPernyataanPembiayaanTindakan(new javax.swing.JFrame(), true);
        ...
        try{
            if(TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                    ...
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on surat_pernyataan_pembiayaan_tindakan.nip=petugas.nip where "+
                    "surat_pernyataan_pembiayaan_tindakan.tanggal between ? and ? order by surat_pernyataan_pembiayaan_tindakan.tanggal");
            }else{
                ps=koneksi.prepareStatement(
                    "select surat_pernyataan_pembiayaan_tindakan.no_surat,reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,reg_periksa.umurdaftar,"+
                    "reg_periksa.sttsumur,pasien.jk,pasien.tgl_lahir,surat_pernyataan_pembiayaan_tindakan.tanggal,surat_pernyataan_pembiayaan_tindakan.nama_pj,"+
                    ...
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on surat_pernyataan_pembiayaan_tindakan.nip=petugas.nip where "+
                    "surat_pernyataan_pembiayaan_tindakan.tanggal between ? and ? and "+
                    "(reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or "+
                    "surat_pernyataan_pembiayaan_tindakan.alamatpj like ? or surat_pernyataan_pembiayaan_tindakan.nama_pj like ? or "+
                    "surat_pernyataan_pembiayaan_tindakan.nip like ? or petugas.nama like ?) "+
                    "order by surat_pernyataan_pembiayaan_tindakan.tanggal");
            }
    ...
    public void emptTeks() {
        ...
        NoKTP.setText("");
        AlamatPj.setText("");
        Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(surat_pernyataan_pembiayaan_tindakan.no_surat,3),signed)),0) from surat_pernyataan_pembiayaan_tindakan where surat_pernyataan_pembiayaan_tindakan.tanggal='"+Valid.SetTgl(Tanggal.getSelectedItem()+"")+"' ",
                "PPT"+Tanggal.getSelectedItem().toString().substring(6,10)+Tanggal.getSelectedItem().toString().substring(3,5)+Tanggal.getSelectedItem().toString().substring(0,2),3,NoSurat);
        NamaPJ.requestFocus();
    }
    ...
    private void ganti() {
        if(Sequel.mengedittf("surat_pernyataan_pembiayaan_tindakan","no_surat=?","no_surat=?,no_rawat=?,tanggal=?,nama_pj=?,no_ktppj=?,tempat_lahirpj=?,lahirpj=?,jkpj=?,alamatpj=?,hubungan=?,no_telp=?,nip=?",13,new String[]{
            NoSurat.getText(),TNoRw.getText(),Valid.SetTgl(Tanggal.getSelectedItem()+""),NamaPJ.getText(),NoKTP.getText(),
            TempatLahir.getText(),Valid.SetTgl(TglLahir.getSelectedItem()+""),JKPJ.getSelectedItem().toString().substring(0,1),
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from surat_pernyataan_pembiayaan_tindakan where no_surat=?",1,new String[]{
    ...
    private void panggilPhoto() {
        if(FormPhoto.isVisible()==true){
            lokasifile="";
            try {
                ps=koneksi.prepareStatement("select surat_pernyataan_pembiayaan_tindakan_pembuat_pernyataan.photo from surat_pernyataan_pembiayaan_tindakan_pembuat_pernyataan where surat_pernyataan_pembiayaan_tindakan_pembuat_pernyataan.no_surat=?");
                try {
                    ...
                    if(rs.next()){
                        if(rs.getString("photo").equals("")||rs.getString("photo").equals("-")){
                            ...
                            LoadHTML2.setText("<html><body><center><img src='http://"+koneksiDB.HOSTHYBRIDWEB()+":"+koneksiDB.PORTWEB()+"/"+koneksiDB.HYBRIDWEB()+"/pernyataanpembiayaantindakan/"+rs.getString("photo")+"' alt='photo' width='500' height='500'/></center></body></html>");
                        }  
                    }else{
                        lokasifile="";
                        LoadHTML2.setText("<html><body><center><br><br><font face='tahoma' size='2' color='#434343'>Kosong</font></center></body></html>");
