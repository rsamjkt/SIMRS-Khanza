 ...
 * @author perpustakaan
 */
public final class RMAssesmentBayiBaruLahir extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMAssesmentBayiBaruLahir(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMAssesmentBayiBaruLahir dialog = new RMAssesmentBayiBaruLahir(new javax.swing.JFrame(), true);
