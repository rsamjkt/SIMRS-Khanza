...
public class DlgCariTagihanOperasi extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel10_Laporan = new widget.Label();
        ...
        panelGlass7.setPreferredSize(new java.awt.Dimension(300, 340));
        panelGlass7.setLayout(null);

        // --- PERUBAHAN DIMULAI DI SINI ---
        
        jLabel10_Laporan.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel10_Laporan.setText("Tanggal Laporan :");
        jLabel10_Laporan.setName("jLabel10_Laporan");
        panelGlass7.add(jLabel10_Laporan);
        jLabel10_Laporan.setBounds(10, 10, 200, 23);
        
        TanggalLaporan.setDisplayFormat("dd-MM-yyyy HH:mm:ss");
        TanggalLaporan.setName("TanggalLaporan");
        TanggalLaporan.setEnabled(true); // Dibuat tidak bisa diedit
        panelGlass7.add(TanggalLaporan);
        TanggalLaporan.setBounds(30, 35, 150, 23);
        ...
        Jaringan.setBounds(30, 255, 256, 23);
...
*/
    ...
    private void BtnCari5ActionPerformed(java.awt.event.ActionEvent evt) {                                         
...
private void MnHapusTagihanOperasiActionPerformed(java.awt.event.ActionEvent evt) {                                                      
    if(tbDokter.getSelectedRow()>-1){
        if(!tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString().equals("")){
            if(Sequel.cariRegistrasi(Valid.SetTgl(TanggalLaporan.getSelectedItem()+"")+" "+TanggalLaporan.getSelectedItem().toString().substring(11,19))>0){
...
private void MnHapusObatOperasiActionPerformed(java.awt.event.ActionEvent evt) {                                                   
    if(tbDokter.getSelectedRow()>-1){
        if(!tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString().equals("")){            
    ...
    private void MnUbahOperatorPetugasActionPerformed(java.awt.event.ActionEvent evt) {                                                      
        if(tbDokter.getSelectedRow()>-1){
            if(!tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString().equals("")){
                if(Sequel.cariRegistrasi(tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString())>0){
    ...
    private void kdoperator1KeyPressed(java.awt.event.KeyEvent evt) {                                       
        if(evt.getKeyCode()==KeyEvent.VK_PAGE_DOWN){
    ...
    private void BtnOperator1ActionPerformed(java.awt.event.ActionEvent evt) {                                             
        pilihan=1;
        dokter.emptTeks();
        dokter.isCek();
    ...
    private void kdasistoperator1KeyPressed(java.awt.event.KeyEvent evt) {                                            
        if(evt.getKeyCode()==KeyEvent.VK_PAGE_DOWN){
    ...
    private void btnAsis1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        pilihan=1;
        petugas.emptTeks();
        petugas.isCek();
    ...
    private void kdoperator2KeyPressed(java.awt.event.KeyEvent evt) {                                       
        if(evt.getKeyCode()==KeyEvent.VK_PAGE_DOWN){
    ...
    private void BtnOperator2ActionPerformed(java.awt.event.ActionEvent evt) {                                             
        pilihan=2;
        dokter.emptTeks();
        dokter.isCek();
        dokter.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
    ...
    private void kdoperator3KeyPressed(java.awt.event.KeyEvent evt) {                                       
        if(evt.getKeyCode()==KeyEvent.VK_PAGE_DOWN){
    ...
    private void btnInstrumenActionPerformed(java.awt.event.ActionEvent evt) {                                             
        pilihan=3;
        dokter.emptTeks();
        dokter.isCek();
        dokter.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
    ...
    private void kdanestesiKeyPressed(java.awt.event.KeyEvent evt) {                                      
        if(evt.getKeyCode()==KeyEvent.VK_PAGE_DOWN){
    ...
    private void BtnAnastesiActionPerformed(java.awt.event.ActionEvent evt) {                                            
        pilihan=4;
        dokter.emptTeks();
        dokter.isCek();
        dokter.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
    ...
    private void kddranakKeyPressed(java.awt.event.KeyEvent evt) {                                    
        if(evt.getKeyCode()==KeyEvent.VK_PAGE_DOWN){
    ...
    private void btnAnakActionPerformed(java.awt.event.ActionEvent evt) {                                        
        pilihan=5;
        dokter.emptTeks();
        dokter.isCek();
        dokter.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
    ...
    private void btnAsis2ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        pilihan=2;
        petugas.emptTeks();
        petugas.isCek();
        petugas.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
    ...
    private void kdasistoperator2KeyPressed(java.awt.event.KeyEvent evt) {                                            
        if(evt.getKeyCode()==KeyEvent.VK_PAGE_DOWN){
    ...
    private void btnAsis3ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        pilihan=3;
        petugas.emptTeks();
        petugas.isCek();
        petugas.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
    ...
    private void kdInstrumenKeyPressed(java.awt.event.KeyEvent evt) {                                       
        if(evt.getKeyCode()==KeyEvent.VK_PAGE_DOWN){
    ...
    private void btnPrwResActionPerformed(java.awt.event.ActionEvent evt) {                                          
        pilihan=5;
        petugas.emptTeks();
        petugas.isCek();
        petugas.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
    ...
    private void kdprwresustKeyPressed(java.awt.event.KeyEvent evt) {                                       
        if(evt.getKeyCode()==KeyEvent.VK_PAGE_DOWN){
    ...
    private void kdasistanestesiKeyPressed(java.awt.event.KeyEvent evt) {                                           
        if(evt.getKeyCode()==KeyEvent.VK_PAGE_DOWN){
    ...
    private void BtnAsnesActionPerformed(java.awt.event.ActionEvent evt) {                                         
        pilihan=4;
        petugas.emptTeks();
        petugas.isCek();
        petugas.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
    ...
    private void kdbidanKeyPressed(java.awt.event.KeyEvent evt) {                                   
        if(evt.getKeyCode()==KeyEvent.VK_PAGE_DOWN){
    ...
    private void btnBidanActionPerformed(java.awt.event.ActionEvent evt) {                                         
        pilihan=7;
        petugas.emptTeks();
        petugas.isCek();
        petugas.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
    ...
    private void kdprwluarKeyPressed(java.awt.event.KeyEvent evt) {                                     
        if(evt.getKeyCode()==KeyEvent.VK_PAGE_DOWN){
    ...
    private void btnPrwLuarActionPerformed(java.awt.event.ActionEvent evt) {                                           
        pilihan=6;
        petugas.emptTeks();
        petugas.isCek();
        petugas.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
    ...
    private void btnBidan2ActionPerformed(java.awt.event.ActionEvent evt) {                                          
        pilihan=8;
        petugas.emptTeks();
        petugas.isCek();
        petugas.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
    ...
    private void kdbidan2KeyPressed(java.awt.event.KeyEvent evt) {                                    
        if(evt.getKeyCode()==KeyEvent.VK_PAGE_DOWN){
    ...
    private void kdbidan3KeyPressed(java.awt.event.KeyEvent evt) {                                    
        if(evt.getKeyCode()==KeyEvent.VK_PAGE_DOWN){
    ...
    private void btnBidan3ActionPerformed(java.awt.event.ActionEvent evt) {                                          
        pilihan=9;
        petugas.emptTeks();
        petugas.isCek();
        petugas.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
    ...
    private void kdonloop1KeyPressed(java.awt.event.KeyEvent evt) {                                     
        if(evt.getKeyCode()==KeyEvent.VK_PAGE_DOWN){
    ...
    private void btnOnloop1ActionPerformed(java.awt.event.ActionEvent evt) {                                           
        pilihan=10;
        petugas.emptTeks();
        petugas.isCek();
        petugas.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
    ...
    private void btnOnloop2ActionPerformed(java.awt.event.ActionEvent evt) {                                           
        pilihan=11;
        petugas.emptTeks();
        petugas.isCek();
        petugas.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
    ...
    private void kdonloop2KeyPressed(java.awt.event.KeyEvent evt) {                                     
        if(evt.getKeyCode()==KeyEvent.VK_PAGE_DOWN){
    ...
    private void btnOnloop3ActionPerformed(java.awt.event.ActionEvent evt) {                                           
        pilihan=12;
        petugas.emptTeks();
        petugas.isCek();
        petugas.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
    ...
    private void kdonloop3KeyPressed(java.awt.event.KeyEvent evt) {                                     
        if(evt.getKeyCode()==KeyEvent.VK_PAGE_DOWN){
    ...
    private void kdpjanakKeyPressed(java.awt.event.KeyEvent evt) {                                    
        if(evt.getKeyCode()==KeyEvent.VK_PAGE_DOWN){
    ...
    private void btndrpjanakActionPerformed(java.awt.event.ActionEvent evt) {                                            
        pilihan=6;
        dokter.emptTeks();
        dokter.isCek();
        dokter.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
    ...
    private void kddrumumKeyPressed(java.awt.event.KeyEvent evt) {                                    
        if(evt.getKeyCode()==KeyEvent.VK_PAGE_DOWN){
            nmdranak.setText(dokter.tampil3(kddranak.getText()));
        }else if(evt.getKeyCode()==KeyEvent.VK_UP){
    ...
    private void btndrumumActionPerformed(java.awt.event.ActionEvent evt) {                                          
        pilihan=7;
        dokter.emptTeks();
        dokter.isCek();
        dokter.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
    ...
    private void kdasistoperator3KeyPressed(java.awt.event.KeyEvent evt) {                                            
        // TODO add your handling code here:
    }                                           

    private void btnAsis4ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        pilihan=15;
        petugas.emptTeks();
        petugas.isCek();
        petugas.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
    ...
    private void kdasistanestesi2KeyPressed(java.awt.event.KeyEvent evt) {                                            
        // TODO add your handling code here:
    }                                           

    private void BtnAsnes1ActionPerformed(java.awt.event.ActionEvent evt) {                                          
        pilihan=16;
        petugas.emptTeks();
        petugas.isCek();
        petugas.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
    ...
    private void kdonloop4KeyPressed(java.awt.event.KeyEvent evt) {                                     
        // TODO add your handling code here:
    }                                    

    private void btnOnloop4ActionPerformed(java.awt.event.ActionEvent evt) {                                           
        pilihan=13;
        petugas.emptTeks();
        petugas.isCek();
        petugas.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
    ...
    private void btnOnloop5ActionPerformed(java.awt.event.ActionEvent evt) {                                           
        pilihan=14;
        petugas.emptTeks();
        petugas.isCek();
        petugas.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
    ...
    private void kdonloop5KeyPressed(java.awt.event.KeyEvent evt) {                                     
        // TODO add your handling code here:
    }                                    
    ...
    private void MnUbahLaporanActionPerformed(java.awt.event.ActionEvent evt) {                                              
        if(tbDokter.getSelectedRow()>-1){
            if(!tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString().equals("")){
                try {
                    rs2=koneksi.prepareStatement(
                        "select laporan_operasi.tanggal,laporan_operasi.diagnosa_preop,laporan_operasi.diagnosa_postop,laporan_operasi.jaringan_dieksekusi,laporan_operasi.selesaioperasi,laporan_operasi.permintaan_pa,"+
                    ...
                    if(rs2.next()){
                        TanggalLaporan.setDate(rs2.getDate("tanggal")); 
                        ...
                        // Jika belum ada laporan, set default values
    ...
    private void BtnPrint1KeyPressed(java.awt.event.KeyEvent evt) {                                     
        if(evt.getKeyCode()==KeyEvent.VK_SPACE){
            BtnPrintActionPerformed(null);
        }else{
    ...
    private void PreOpKeyPressed(java.awt.event.KeyEvent evt) {                                 
        Valid.pindah(evt,tgl2,PostOp);
    }                                

    private void PostOpKeyPressed(java.awt.event.KeyEvent evt) {                                  
        Valid.pindah(evt,PreOp,Jaringan);
    }                                 

    private void JaringanKeyPressed(java.awt.event.KeyEvent evt) {                                    
        Valid.pindah(evt,PostOp,DikirimPA);
    }                                   

    private void DikirimPAKeyPressed(java.awt.event.KeyEvent evt) {                                     
    ...
    private void btnAmbilPhoto1ActionPerformed(java.awt.event.ActionEvent evt) {                                               
    ...
    private void MnLaporanTindakanActionPerformed(java.awt.event.ActionEvent evt) {                                                  
        ...
        if(tbDokter.getSelectedRow()>-1){
            if(!tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString().equals("")){
                ...
                Valid.MyReport("rptLaporanTindakanKuret.jasper","report","::[ Laporan Tindakan ]::",param);
            }else{
                JOptionPane.showMessageDialog(rootPane,"Silahkan pilih data, klik pada No.Rawat ..!!");
            } 
        }
    ...
    */
    ...
    private widget.Label jLabel10_Laporan;
